...
import sm.cgs.imagen.AutoTintadoOp;
import sm.cgs.imagen.PosterizarOp;
import sm.cgs.imagen.RedOp;
...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botonEdicion = new javax.swing.JToggleButton();
        ...
        botonDesplegableColoresBorde = new javax.swing.JComboBox<>(colores);
        botonDesplegableColoresRelleno = new javax.swing.JComboBox<>(colores);
        botonGrosor = new javax.swing.JSpinner();
        botonDesplegableRelleno = new javax.swing.JComboBox<>();
        ...
        seleccionMascara.setPreferredSize(new java.awt.Dimension(80, 26));
        ...
        botonIluminarZonasOscuras.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/acllararzonasoscuras.png"))); // NOI18N
        ...
        panelCuadratico.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        botonCombinarBandas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/combinar.png"))); // NOI18N
        botonCombinarBandas.addActionListener(formListener);
        panelCuadratico.add(botonCombinarBandas);
        ...
        jPanel1.add(botonCuadratica, java.awt.BorderLayout.CENTER);
        ...
        jPanel1.add(sliderCuadratico, java.awt.BorderLayout.PAGE_END);

        panelCuadratico.add(jPanel1);

        botonEnverdecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/green-dot.png"))); // NOI18N
        botonEnverdecedor.setToolTipText("Enverdecer");
        botonEnverdecedor.addActionListener(formListener);
        panelCuadratico.add(botonEnverdecedor);
        ...
        jPanel5.add(botonTintado, java.awt.BorderLayout.PAGE_START);

        sliderTintado.setToolTipText("Tintado interactivo");
        ...
        jPanel5.add(sliderTintado, java.awt.BorderLayout.CENTER);

        panelCuadratico.add(jPanel5);

        botonAutoTintado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/autoTintado.png"))); // NOI18N
        botonAutoTintado.setToolTipText("Auto Tintado");
        botonAutoTintado.addActionListener(formListener);
        panelCuadratico.add(botonAutoTintado);
        ...
        panelCuadratico.add(botonSepia);
        ...
        panelCuadratico.add(botonEcualizacion);

        jPanel4.setLayout(new java.awt.BorderLayout());

        botonRealceRojo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/rojo.png"))); // NOI18N
        botonRealceRojo.setToolTipText("Realzar Rojo");
        botonRealceRojo.addActionListener(formListener);
        jPanel4.add(botonRealceRojo, java.awt.BorderLayout.CENTER);

        sliderRojo.setMaximum(255);
        sliderRojo.setMinimum(2);
        sliderRojo.setToolTipText("Rojo interactivo");
        sliderRojo.setValue(128);
        sliderRojo.setPreferredSize(new java.awt.Dimension(100, 26));
        sliderRojo.addChangeListener(formListener);
        sliderRojo.addFocusListener(formListener);
        jPanel4.add(sliderRojo, java.awt.BorderLayout.PAGE_END);

        panelCuadratico.add(jPanel4);

        sliderPosterizacion.setMaximum(20);
        sliderPosterizacion.setMinimum(2);
        sliderPosterizacion.setToolTipText("Posterizacion");
        ...
        panelCuadratico.add(sliderPosterizacion);

        barraOpcionesImagen.add(panelCuadratico);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Color"));

        botonMostrarBandas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/bandas.png"))); // NOI18N
        botonMostrarBandas.addActionListener(formListener);
        jPanel3.add(botonMostrarBandas);

        seleccionEspacioColor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "sRGB", "YCC", "Grey", "YCbCr" }));
        seleccionEspacioColor.addActionListener(formListener);
        jPanel3.add(seleccionEspacioColor);

        barraOpcionesImagen.add(jPanel3);
        ...
        botonAmpliar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/aumentar.png"))); // NOI18N
        botonAmpliar.addActionListener(formListener);
        panelEscalado.add(botonAmpliar);

        botonReduccion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/disminuir.png"))); // NOI18N
        ...
        botonSeleccionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/seleccion.png"))); // NOI18N
        ...
        GrupoBotonesHerramientas.add(botonEdicion);
        botonEdicion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/edicion.png"))); // NOI18N
        botonEdicion.setToolTipText("Edicion");
        botonEdicion.setFocusable(false);
        botonEdicion.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        botonEdicion.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        botonEdicion.addActionListener(formListener);
        barraFormas.add(botonEdicion);
        ...
        botonDesplegableColoresBorde.setToolTipText("Color Borde");
        botonDesplegableColoresBorde.setRenderer(new ColorCellRender());
        botonDesplegableColoresBorde.addActionListener(formListener);
        barraAtributos.add(botonDesplegableColoresBorde);

        botonDesplegableColoresRelleno.setToolTipText("Color Relleno");
        botonDesplegableColoresRelleno.setRenderer(new ColorCellRender());
        botonDesplegableColoresRelleno.addActionListener(formListener);
        barraAtributos.add(botonDesplegableColoresRelleno);
        ...
        botonDesplegableRelleno.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sin Relleno", "Relleno Liso", "Degradado Horizontal", "Degradado Vertical", "Degradado Diagonal" }));
        botonDesplegableRelleno.setToolTipText("Seleccionar el tipo de relleno");
        botonDesplegableRelleno.addActionListener(formListener);
        barraAtributos.add(botonDesplegableRelleno);
        ...
        botonRecorte.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/recortar.png"))); // NOI18N
        ...
        botonAplicarOperaciones.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/aplicar.png"))); // NOI18N
        ...
        barraCoordenadas.setText("Coordenadas y Color");
        ...
        menuAcercaDe.addActionListener(formListener);
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.FocusListener, java.awt.event.MouseMotionListener, javax.swing.event.ChangeListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            else if (evt.getSource() == botonCombinarBandas) {
                VentanaPrincipal.this.botonCombinarBandasActionPerformed(evt);
            }
            else if (evt.getSource() == botonCuadratica) {
                VentanaPrincipal.this.botonCuadraticaActionPerformed(evt);
            }
            else if (evt.getSource() == botonEnverdecedor) {
                VentanaPrincipal.this.botonEnverdecedorActionPerformed(evt);
            }
            ...
            else if (evt.getSource() == botonRealceRojo) {
                VentanaPrincipal.this.botonRealceRojoActionPerformed(evt);
            }
            else if (evt.getSource() == botonMostrarBandas) {
                VentanaPrincipal.this.botonMostrarBandasActionPerformed(evt);
            }
            else if (evt.getSource() == seleccionEspacioColor) {
                VentanaPrincipal.this.seleccionEspacioColorActionPerformed(evt);
            }
            ...
            else if (evt.getSource() == botonEdicion) {
                VentanaPrincipal.this.botonEdicionActionPerformed(evt);
            }
            else if (evt.getSource() == botonDesplegableColoresBorde) {
                VentanaPrincipal.this.botonDesplegableColoresBordeActionPerformed(evt);
            }
            else if (evt.getSource() == botonDesplegableColoresRelleno) {
                VentanaPrincipal.this.botonDesplegableColoresRellenoActionPerformed(evt);
            }
            else if (evt.getSource() == botonDesplegableRelleno) {
                VentanaPrincipal.this.botonDesplegableRellenoActionPerformed(evt);
            }
            ...
            else if (evt.getSource() == menuAcercaDe) {
                VentanaPrincipal.this.menuAcercaDeActionPerformed(evt);
            }
            else if (evt.getSource() == botonAutoTintado) {
                VentanaPrincipal.this.botonAutoTintadoActionPerformed(evt);
            }
        }
        ...
        public void focusGained(java.awt.event.FocusEvent evt) {
            ...
            else if (evt.getSource() == sliderRojo) {
                VentanaPrincipal.this.sliderRojoFocusGained(evt);
            }
        ...
        public void focusLost(java.awt.event.FocusEvent evt) {
            if (evt.getSource() == sliderBrillo) {
                ...
                VentanaPrincipal.this.sliderRojoFocusLost(evt);
            }
            else if (evt.getSource() == sliderPosterizacion) {
        ...
        public void stateChanged(javax.swing.event.ChangeEvent evt) {
            if (evt.getSource() == sliderBrillo) {
                ...
                VentanaPrincipal.this.sliderRojoStateChanged(evt);
            }
            else if (evt.getSource() == sliderPosterizacion) {
    ...
    private void botonDesplegableColoresBordeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonDesplegableColoresBordeActionPerformed
       VentanaInterna vi;
        vi = (VentanaInterna) escritorio.getSelectedFrame();
        
        if (botonEdicion.isSelected() && vi.getLienzo2D().getFigura() != null) {
            if (vi != null) {
                vi.getLienzo2D().getFigura().setColor_borde((Color) botonDesplegableColoresBorde.getSelectedItem());
                vi.getLienzo2D().repaint();
            }
        } else {
            if (vi != null) {
                vi.getLienzo2D().setColor_borde((Color) botonDesplegableColoresBorde.getSelectedItem());
                vi.getLienzo2D().repaint();
            }
        }
    }//GEN-LAST:event_botonDesplegableColoresBordeActionPerformed
    ...
    private void botonGrosorStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_botonGrosorStateChanged
        ...
        if (vi != null) {
            if (botonEdicion.isSelected() && vi.getLienzo2D().getFigura() != null) {
                vi.getLienzo2D().getFigura().setTrazo((int) botonGrosor.getValue());
                vi.getLienzo2D().repaint();
            } else {
    ...
    private void botonAlisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAlisarActionPerformed
        ...
        if (vi != null) {
            if (botonEdicion.isSelected() && vi.getLienzo2D().getFigura() != null) {
                vi.getLienzo2D().getFigura().setAntialiasing(botonAlisar.isSelected());
                vi.getLienzo2D().repaint();
            } else {

                vi.getLienzo2D().setAlisar(botonAlisar.isSelected());
                vi.getLienzo2D().repaint();
            }
        }
    ...
    private void botonMostrarBandasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonMostrarBandasActionPerformed
        VentanaInterna vi = (VentanaInterna) (escritorio.getSelectedFrame());
        if (vi != null) {
            BufferedImage img = vi.getLienzo2D().getImage(false);
            if (img != null) {
    ...
    }//GEN-LAST:event_botonMostrarBandasActionPerformed
    ...
    private void botonEnverdecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEnverdecedorActionPerformed
        VentanaInterna vi = (VentanaInterna) (escritorio.getSelectedFrame());
        if (vi != null) {
            BufferedImage img = vi.getLienzo2D().getImage(false);
            if (img != null) {
    ...
    }//GEN-LAST:event_botonEnverdecedorActionPerformed

    private void menuAcercaDeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAcercaDeActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(this,"Practica SM, Version 0.12, Carlos Garcia Segura");
    }//GEN-LAST:event_menuAcercaDeActionPerformed

    private void botonDesplegableColoresRellenoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonDesplegableColoresRellenoActionPerformed
        VentanaInterna vi;
        vi = (VentanaInterna) escritorio.getSelectedFrame();

        if (botonEdicion.isSelected() && vi.getLienzo2D().getFigura() != null) {
            if (vi != null) {
                vi.getLienzo2D().getFigura().setColor_relleno((Color) botonDesplegableColoresRelleno.getSelectedItem());
                vi.getLienzo2D().repaint();
            }
        } else {
            if (vi != null) {
                vi.getLienzo2D().setColor_relleno((Color) botonDesplegableColoresRelleno.getSelectedItem());
                vi.getLienzo2D().repaint();
            }
        }
    }//GEN-LAST:event_botonDesplegableColoresRellenoActionPerformed
    ...
    private void sliderTransparenciaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderTransparenciaStateChanged
        ...
        if (vi != null) {
            if (botonEdicion.isSelected() && vi.getLienzo2D().getFigura() != null) {
                vi.getLienzo2D().getFigura().setGrado_transparencia(sliderTransparencia.getValue() / 100.0f);
                vi.getLienzo2D().repaint();
            } else {
                vi.getLienzo2D().setTransparencia(sliderTransparencia.getValue() / 100.0f);
            }
        }
    }//GEN-LAST:event_sliderTransparenciaStateChanged

    private void botonDesplegableRellenoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonDesplegableRellenoActionPerformed
        VentanaInterna vi;
        vi = (VentanaInterna) escritorio.getSelectedFrame();
        if (vi != null) {
            if (botonEdicion.isSelected()) {
                vi.getLienzo2D().getFigura().setTipo_relleno(botonDesplegableRelleno.getSelectedIndex());
                vi.getLienzo2D().repaint();
            } else {
                vi.getLienzo2D().setTipo_relleno(botonDesplegableRelleno.getSelectedIndex());
            }
        }
    }//GEN-LAST:event_botonDesplegableRellenoActionPerformed

    private void botonEdicionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEdicionActionPerformed
        VentanaInterna vi;
        vi = (VentanaInterna) escritorio.getSelectedFrame();
        if (vi != null) {
            vi.getLienzo2D().setHerramienta("edicion");
            barraEstado.setText("Edicion");
        }
    ...
    private void botonTintadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonTintadoActionPerformed
        ...
        if (vi != null) {
            ...
            if (img != null) {
                try {
                    TintOp tintado = new TintOp((Color) botonDesplegableColoresBorde.getSelectedItem(), 0.5f);
    ...
    private void sliderPosterizacionStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderPosterizacionStateChanged
        ...
        if (vi != null) {
            ...
            if (imgFuente != null) {
                try {
                    PosterizarOp op = new PosterizarOp(sliderPosterizacion.getValue());
    ...
    private void botonRealceRojoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRealceRojoActionPerformed
        VentanaInterna vi = (VentanaInterna) (escritorio.getSelectedFrame());
        if (vi != null) {
            BufferedImage img = vi.getLienzo2D().getImage(false);
            if (img != null) {
                try {
                    RedOp op = new RedOp(20);
                    op.filter(img, img);
                    vi.getLienzo2D().repaint();
                } catch (IllegalArgumentException e) {
                    System.err.println(e.getLocalizedMessage());
    ...
    }//GEN-LAST:event_botonRealceRojoActionPerformed
    ...
    private void sliderTintadoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderTintadoStateChanged
        ...
        if (vi != null) {
            ...
            if (imgFuente != null) {
                try {
                    TintOp tintado = new TintOp((Color)botonDesplegableColoresBorde.getSelectedItem(), sliderTintado.getValue()/100.0f);
    ...
    private void sliderRojoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderRojoStateChanged
      VentanaInterna vi = (VentanaInterna) (escritorio.getSelectedFrame());
        if (vi != null) {
            ...
            if (imgFuente != null) {
                try {
                    RedOp op = new RedOp(sliderRojo.getValue());
                    op.filter(imgFuente, img);
                    vi.getLienzo2D().repaint();
                } catch (IllegalArgumentException e) {
                    System.err.println(e.getLocalizedMessage());
    ...
    private void botonAutoTintadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAutoTintadoActionPerformed
        VentanaInterna vi = (VentanaInterna) (escritorio.getSelectedFrame());
        if (vi != null) {
            BufferedImage img = vi.getLienzo2D().getImage(false);
            if (img != null) {
                try {
                    AutoTintadoOp tintado = new AutoTintadoOp((Color)botonDesplegableColoresBorde.getSelectedItem());
                    tintado.filter(img, img);
                    vi.getLienzo2D().repaint();
                } catch (IllegalArgumentException e) {
                    System.err.println(e.getLocalizedMessage());
    ...
    }//GEN-LAST:event_botonAutoTintadoActionPerformed

    
    
    private void CrearImagenFuente() {
        VentanaInterna vi = (VentanaInterna) (escritorio.getSelectedFrame());
        if (vi != null) {
            if (botonAplicarOperaciones.isSelected()) {
                vi.getLienzo2D().volcar();
    ...
    private void InicializarVentana(VentanaInterna vi)
    {
      ...
      //  vi.getLienzo2D().setColor(Color.BLACK);
        botonDesplegableColoresBorde.setSelectedItem(Color.BLACK);
        botonDesplegableColoresRelleno.setSelectedItem(Color.BLACK);
        botonPunto.setSelected(true);
        botonAlisar.setSelected(false);
        botonDesplegableRelleno.setSelectedIndex(0);
    ...
    private class ManejadorVentanaInterna extends InternalFrameAdapter {
        ...
        public void internalFrameActivated(javax.swing.event.InternalFrameEvent evt) {
            ...
            botonDesplegableRelleno.setSelectedIndex(vi.getLienzo2D().getTipo_relleno());
          
            botonAlisar.setSelected(vi.getLienzo2D().isAlisar());
            botonRecorte.setSelected(vi.getLienzo2D().isRecorte());
            botonDesplegableColoresBorde.setSelectedItem(vi.getLienzo2D().getColor_borde());
            botonDesplegableColoresRelleno.setSelectedItem(vi.getLienzo2D().getColor_relleno());
    ...
    private class ManejadorClickRaton extends MouseAdapter {
        ...
        public void mouseClicked (java.awt.event.MouseEvent evt)
        {
            VentanaInterna vi;
            vi = (VentanaInterna) escritorio.getSelectedFrame();
            SMShape figura = vi.getLienzo2D().getFigura();
            if (botonEdicion.isSelected() && figura != null)
            {
                botonDesplegableColoresRelleno.setSelectedItem(figura.getColor_relleno());
                botonDesplegableColoresBorde.setSelectedItem(figura.getColor_borde());
                botonGrosor.setValue(vi.getLienzo2D().getFigura().getTrazo());
                botonDesplegableRelleno.setSelectedIndex(figura.getTipo_relleno());
                sliderTransparencia.setValue((int)(figura.getGrado_transparencia()*100.0f));
                botonAlisar.setSelected(figura.isAntialiasing());
                
                
                if (figura instanceof Linea2D)
                {
                    barraEstado.setText("Editando linea");
                }else if (figura instanceof Rectangulo2D)
                {
                   barraEstado.setText("Editando Rectangulo"); 
                }else if (figura instanceof Elipse2D)
                {
                    barraEstado.setText("Editando Elipse");
                }
    ...
    private class ManejadorRaton extends MouseMotionAdapter {
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt) {
            ...
            if (vi != null) {
                BufferedImage img = vi.getLienzo2D().getImage(false);
                if (img != null && p.getX() < img.getWidth() && p.getX() > 0 && p.getY() > 0 && evt.getY() < img.getHeight()) {
                    Color color = new Color(img.getRGB((int) p.getX(), (int) p.getY()));
                    
                    barraCoordenadas.setText("x:" + p.getX() + ", y:" + p.getY() + "    R: " + color.getRed() + " G: " + color.getGreen() + " B: " + color.getBlue());
                }
            }
        }
    }
    ...
    private javax.swing.JButton botonAutoTintado;
    ...
    private javax.swing.JComboBox<Color> botonDesplegableColoresBorde;
    private javax.swing.JComboBox<Color> botonDesplegableColoresRelleno;
    private javax.swing.JComboBox<String> botonDesplegableRelleno;
    private javax.swing.JButton botonDuplicar;
    private javax.swing.JButton botonEcualizacion;
    private javax.swing.JToggleButton botonEdicion;
    private javax.swing.JToggleButton botonElipse;
    private javax.swing.JButton botonEnverdecedor;
    ...
    private javax.swing.JButton botonMostrarBandas;
    ...
    private javax.swing.JButton botonRealceRojo;
