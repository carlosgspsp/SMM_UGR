 ...
 * @author carlo
 */
public class Rectangulo2D extends java.awt.geom.Rectangle2D.Float implements SMShape {
    ...
    public Rectangulo2D(Point punto, Color colorb , Color colorr, int trazo, int discontinuidad,int union, int tipo_relleno, boolean alisar,boolean dithering, boolean color_rendering, float grado_transparencia)
    {
       p1 = punto;
       color_borde = colorb;
